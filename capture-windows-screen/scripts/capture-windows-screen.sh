...
WIN_SCRIPT="${WIN_SCRIPT:-C:\OpenClaw\capture-screen.ps1}"
OUT_WIN="${OUT_WIN:-C:\OpenClaw\latest-screen.png}"
OUT_WSL="${OUT_WSL:-/mnt/c/OpenClaw/latest-screen.png}"
STAGE_DIR="${STAGE_DIR:-/home/lhs/.openclaw/workspace/tmp-media}"
PS_EXEC_POLICY="${PS_EXEC_POLICY:-RemoteSigned}"
...
"$WIN_PS" -NoProfile -ExecutionPolicy "$PS_EXEC_POLICY" -File "$WIN_SCRIPT" -OutputPath "$OUT_WIN" >/dev/null
